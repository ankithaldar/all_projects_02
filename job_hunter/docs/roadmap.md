...
| `feature_07_normalizer_dedupe` | P2 | Data quality | normalizer service (city/mode/employment mapping), content_hash dedupe, stale sweep, quarantine path | rerunning a source inserts zero dupes; 45d staleness works |
